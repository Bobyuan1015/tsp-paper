    ...
    for runs_dimension in ['max', 'min', 'mean']:
        ...
        for group_name, group_data in grouped_data:
            ...
            try:
                ...
                axes[2, 0].set_title('Performance Degradation Analysis', fontsize=10, fontweight='bold', pad=20)
...
def main():
    ...
    data_paths = [
        ...
        "/home/y/workplace/mac-bk/git_code/clean/tsp-paper/results/tsp_rl_ablation_DQN_cross_instance_20250803_233953/experiment_data_20250803_233953.csv"
    ]
